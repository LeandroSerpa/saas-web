...
function aplicarTelefoneNotificacao(evento) {
  if (!notificacaoEditando.value) return
  notificacaoEditando.value.telefoneDestino = sanitizarTelefoneDoEvento(evento)
}

function aplicarTelefoneManual(evento) {
  manual.value.telefoneDestino = sanitizarTelefoneDoEvento(evento)
}
  ...
  <main class="pagina">
    ...
    <section v-if="abaAtiva === 'notificacoes'" class="secao">
      <section v-if="notificacaoEditando" class="card formulario">
        ...
        <div class="campos">
          ...
          <label>Telefone destino <input :value="notificacaoEditando.telefoneDestino" type="text" inputmode="numeric" @input="aplicarTelefoneNotificacao" @paste.prevent="aplicarTelefoneNotificacao" /></label>
    ...
    <section v-if="abaAtiva === 'manual'" class="card formulario">
      <div class="campos">
        ...
        <label>Telefone destino opcional <input :value="manual.telefoneDestino" type="text" inputmode="numeric" @input="aplicarTelefoneManual" @paste.prevent="aplicarTelefoneManual" /></label>
